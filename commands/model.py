...
def handle_model_command(msg_type, number, new_model, send_msg):
    try:
        ...
        send_msg(msg_type, number, f"Model updated to {new_model} and configuration reloaded successfully.")
    except Exception as e:
        send_msg(msg_type, number, f"Failed to update model: {str(e)}")