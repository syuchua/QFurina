...
async def handle_history_command(msg_type, recipient_id, send_msg):
    recent_messages = db.get_recent_messages(user_id=recipient_id, limit=10)
    if recent_messages:
...
async def handle_clear_history_command(msg_type, recipient_id, send_msg):
    recent_messages = db.get_recent_messages(user_id=recipient_id, limit=10)
